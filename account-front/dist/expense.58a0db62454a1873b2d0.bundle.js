...
console.log("지출");
function saveInputData(payedMoney, payment, category, memo, year, month, day) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const response = yield fetch("/api/expend", requstOption);
...
function submitInputData() {
    console.log("클릭2222");
    const paymentEl = document.querySelector("input[name='payment']:checked"); //스트링
    const payedMoneyEl = document.querySelector(".payedMoney"); //숫자
    ...
    saveInputData(Number(payedMoneyEl.value), paymentEl.value, categoryEl.options[categoryEl.selectedIndex].value, memoEl.value, Number(year), Number(month), Number(day));
}
